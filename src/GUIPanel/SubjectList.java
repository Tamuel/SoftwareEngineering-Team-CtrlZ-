...
public class SubjectList extends JPanel{
	...
	public SubjectList(int height, Account account, BulletinBoardFrame boardFrame, TitleBar titleBar) {
		...
		assignmentButton = new SimpleButton("����", "�Խ���", subjectButtonHeight, subjectButtonWidth / 2);
		...
		questionButton = new SimpleButton("����", "�Խ���", subjectButtonHeight, subjectButtonWidth / 2);
		...
		if(account.isStudent()) {
			...
			for(int i = 0; i < ((StudentAccount)account).getSubjects().size(); i++) {
				SimpleButton temp = new SimpleButton(((StudentAccount)account).getSubjects().get(i).getName(),
						((StudentAccount)account).getSubjects().get(i).getProfessor().getName() + " ������",
